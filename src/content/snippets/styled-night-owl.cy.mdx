...
description: Gweithrediad styled component o'r elfen html pre ar gyfer MDX gan ddefnyddio thema night owl.
tags:
  - javascript
  - react
  - mui
...
Mae defnyddio [rehype-prism-plus](https://github.com/timlrx/rehype-prism-plus), ategyn rehype i amlygu blociau cod yn HTML gyda prism, yn arwain at greu set benodol o enwau dosbarth yn dibynnu ar y cod a ddefnyddir. Mae'r [MUI](https://mui.com/) styled component ganlynol yn targedu'r dosbarthiadau hynny ac yn eu harddull yn seiliedig ar [thema night owl](https://marketplace.visualstudio.com/items?itemName=sdras.night-owl&WT.mc_id=twitter-social-sdras). Mae'n cyfrif am fodd golau a modd tywyll.
